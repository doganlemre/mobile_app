                ...
                child: Column(
                  children: [
                    SingleChildScrollView(
                      ...
                      child: Row(
                        children: [
                          storyWidget("assets/images/chrisevans.jpg", "Chris Evans"),
                          storyWidget(
                              "assets/images/thor.webp", "Chris Hemsworth"),
                          storyWidget("assets/images/cillian.jpg", "Cillian Murphy"),
                          storyWidget(
                              "assets/images/rdj.webp", "Robert Downey Junior"),
                          storyWidget("assets/images/rdj.webp", "Robert Downey Junior"),
                          storyWidget("assets/images/scarletjohansson.jpg", "Scarlett Johansson"),
                          storyWidget("assets/images/chrisevans.jpg", "Chris Evans"),
                          storyWidget(
                              "assets/images/thor.webp", "Chris Hemsworth"),
                          storyWidget("assets/images/cillian.jpg", "Cillian Murphy"),
                    ...
                    PostItem("assets/images/chrisevans.jpg", "assets/images/ayasofya.jpg",
                        "Chris Evans", "Ayasofya Camii"),
                    PostItem("assets/images/thor.webp", "assets/images/avcılarsahil.webp",
                        "Chris Hemsworth", "Avcılar Sahil"),
                    PostItem("assets/images/cillian.jpg", "assets/images/taksimmeydan.jpg",
                        "Cillian Murphy", "Taksim Meydanı"),
                    PostItem("assets/images/rdj.webp", "assets/images/topkapısaray.jpg",
                        "RobertDowneyJunior", "Topkapı Sarayı"),
                    PostItem("assets/images/scarletjohansson.jpg", "assets/images/mecidiyekoymeydan.jpg",
                        "Scarlett Johansson", "Mecidiyeköy Meydanı"),
                  ],
                ),
              )),
            ),
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              CommentBox("doganlemre", "elinize saglik hocam. "),
            ],
          ),
        ),
      );
