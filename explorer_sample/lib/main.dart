      ...
      child: Column(
        children: [
          ...
          SingleChildScrollView(
            ...
            child: Row(
              children: [
                LocationsItem("assets/images/topkapısaray.jpg", "Topkapı Sarayı",
                    "15km from you", "18.0"),
                LocationsItem("assets/images/taksimmeydan.jpg", "Taksim Meydanı",
                    "13km from you", "15.0"),
                LocationsItem("assets/images/ayasofya.jpg", "Ayasofya Camii",
                    "17km from you", "13.0"),
                LocationsItem("assets/images/mecidiyekoymeydan.jpg", "Mecidiyeköy Meydanı",
                    "11km from you", "16.0"),
                LocationsItem("assets/images/topkapısaray.jpg", "Topkapı Sarayı",
                    "15km from you", "18.0"),
                LocationsItem("assets/images/taksimmeydan.jpg", "Taksim Meydanı",
      ...
      child: Column(
        ...
        children: [
          ...
          SingleChildScrollView(
            ...
            child: Row(
              children: [
                StoryItem("assets/images/chrisevans.jpg", "Chris Evans"),
                StoryItem("assets/images/rdj.webp", "Robert Downey Junior"),
                StoryItem("assets/images/cillianmurphy.jpg", "Cillian Murphy"),
                StoryItem("assets/images/scarletjohansson.jpg", "Scarlett Johansson"),
                StoryItem("assets/images/chrisevans.jpg", "Chris Evans."),
                StoryItem("assets/images/rdj.webp", "Robert Downey Junior"),
                StoryItem("assets/images/cillianmurphy.jpg", "Cillian Murphy"),
                StoryItem("assets/images/scarletjohansson.jpg", "Scarlett Johansson"),
                StoryItem("assets/images/chrisevans.jpg", "Chris Evans"),
                StoryItem("assets/images/thor.webp", "Chris Hemsworth"),
                StoryItem("assets/images/rdj.webp", "Robert Downey Junior"),
                StoryItem("assets/images/cillianmurphy.jpg", "Cillian Murphy"),
                StoryItem("assets/images/scarletjohansson.jpg", "Scarlett Johansson"),
                StoryItem("assets/images/thor.webp", "Chris Hemsworth"),
